...
void SYS_ParameterDisplay(unsigned char mode)
{
	...
	else if(mode == MODE_3d_1d_kW)//_ _ . _ Kw
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d kW  ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d kW  ",(int)edit_Temp/10,(int)edit_Temp%10));
	...
	else if(mode == MODE_3d_1d_Vrms)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d Vrms ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d Vrms ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	else if(mode == MODE_3d_1d_Arms)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d Arms ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d Arms ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	...
	else if(mode == MODE_3d_1d_Hz)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d Hz   ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d Hz   ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_kHz)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d kHz  ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d kHz  ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_s)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d s    ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d s    ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_persent)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d %     ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d %     ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_V)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d V    ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d V    ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_deg)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d deg  ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d deg  ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_ms)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d ms   ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d ms   ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	else if(mode == MODE_3d_1d_mV)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mV   ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mV   ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	else if(mode == MODE_5d_mA)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d mA   ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d mA   ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
	...
	else if(mode == MODE_3d_1d_mA)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mA   ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mA   ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_3d_1d_A)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d A  ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d A  ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	else if(mode == MODE_5d)//_ _ _ _ _
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d    ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d    ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
	}
	else if(mode == MODE_5d_rms)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d rpm  ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d rpm  ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
	}
	...
	else if(mode == MODE_5d_A)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d A    ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d A    ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
	...
	else if(mode == MODE_5d_V)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d V    ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d V    ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
	...
	else if(mode == MODE_3d_1d_mOhm)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mOhm ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mOhm ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	else if(mode == MODE_3d_1d_mH)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mH   ",(int)Temporary/10,(int)Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 3d.% 1d mH   ",(int)edit_Temp/10,(int)edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
	...
	else if(mode == MODE_5d_Vrms)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d Vrms ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d Vrms ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
	}
	else if(mode == MODE_5d_mV)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d mV   ",(int)Temporary));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 5d mV   ",(int)edit_Temp));
			SYS_cursor_ON_Mode(CURSOR_MODE_1);
		}
...
void SYS_ParameterEdt(unsigned int addr,unsigned int e_temp,  long MAX, long Min ,unsigned char mode)
{
	...
	else if(mode==EDIT_MODE_UPDN)//selset
	{
			if(KeyState.KeyValue == ENTER)
			{
				WriteDataMem(addr, e_temp);
			...
			{
				e_temp++;
				if(MAX< e_temp)e_temp = Min;
				
				RefreshFlag=1;
			}
			else if(KeyState.KeyValue == DN)
			{
				if(Min< e_temp)e_temp--;
				else e_temp = MAX;
	...
	else if(mode==EDIT_MODE_P8_DI_FUNC)//selset
	{
		if(KeyState.KeyValue == ENTER)
		{
			WriteDataMem(addr, e_temp);
		...
		else if(KeyState.KeyValue == UP)
		{
			...
			else if(e_temp == 3) e_temp = 4;
			else if(e_temp == 4) e_temp = 5;
			else if(e_temp == 5) e_temp = 6;
			else if(e_temp == 6) e_temp = 7;
			else if(e_temp == 7) e_temp = 10;
		...
		else if(KeyState.KeyValue == DN)
		{
			...
			else if(e_temp == 4) e_temp = 3;
			else if(e_temp == 5) e_temp = 4;
			else if(e_temp == 6) e_temp = 5;
			else if(e_temp == 7) e_temp = 6;
			else if(e_temp == 10) e_temp = 7;
	...
	else if(mode==EDIT_MODE_P11_AO_Sel)//selset
	{
		if(KeyState.KeyValue == ENTER)
		{
			WriteDataMem(addr, e_temp);
		...
		e_temp = (int)BOUND((int)e_temp,MAX,Min);
		edit_Temp = e_temp;
...
void SYS_NaviFunc(void(*ESC_Func)(void),void(*DN_Func)(void),void(*UP_Func)(void),void(*ENTER_Func)(void))
{
	if(KeyState.KeyValue == ESC)MenuDisplay = ESC_Func;
	else if(KeyState.KeyValue == DN)MenuDisplay = DN_Func;
	else if(KeyState.KeyValue == UP)MenuDisplay = UP_Func;
	else if(KeyState.KeyValue == ENTER)MenuDisplay = ENTER_Func;
...
void SYS_0_0(void)
{
	...
	else if(KeyState.KeyValue == DN)
	{
		...
		if(device_type == DEV_IM)MenuDisplay = SYS_0_5;
		else if(device_type == DEV_DCDC)MenuDisplay = SYS_0_1;
	}
	else if(KeyState.KeyValue == UP)
	{
...
void SYS_1_0_06(void)
{
	...
	if(RefreshFlag)
	{
		...
		if(device_type == DEV_IM)
		{
			...
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d A    ",(int)DATA_Registers[2316]/10,DATA_Registers[2316]%10));
		}
		else if(device_type == DEV_DCDC)
		{
...
void SYS_1_0_07(void)
{
	...
	if(RefreshFlag)
	{
		...
		if(device_type == DEV_IM)
		{
			...
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d A   ",(int)DATA_Registers[2317]/10,DATA_Registers[2317]%10));
		}
		else if(device_type == DEV_DCDC)
		{
...
void SYS_1_0_08(void)
{
	...
	if(RefreshFlag)
	{
		...
		if(device_type == DEV_IM)
		{
			...
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d kW  ",(int)DATA_Registers[2318]/10,DATA_Registers[2318]%10));
		}
		else if(device_type == DEV_DCDC)
		{
...
void SYS_1_0_09(void)
{
	...
	if(RefreshFlag)
	{
		...
		if(device_type == DEV_IM)
		{
			...
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d kW  ",(int)DATA_Registers[2319]/10,DATA_Registers[2319]%10));
		}
		else if(device_type == DEV_DCDC)
		{
...
void SYS_1_1_03(void)
{
	...
	if(RefreshFlag){
		...
		CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mA  ",(int)DATA_Registers[2343]/1000,DATA_Registers[2343]%1000));
	}
}
void SYS_1_1_04(void)
{
	...
	if(RefreshFlag){
		...
		CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d mA  ",(int)DATA_Registers[2344]/1000,DATA_Registers[2344]%1000));
	}
}
...
void SYS_1_2_01(void)
{
	...
	if(RefreshFlag){
		...
		if(device_type == DEV_IM)
		{
			if(DATA_Registers[246] == 0)	  CLCD_string(0xC0,"  V/F Freq_Ctrl   ");
			else if(DATA_Registers[246] == 1) CLCD_string(0xC0,"  V/F Speed_Ctrl  ");
			else if(DATA_Registers[246] == 4) CLCD_string(0xC0,"  S/L Vect_Ctrl   ");
			else if(DATA_Registers[246] == 3) CLCD_string(0xC0,"  Vector_Ctrl     ");
...
void SYS_1_2_02(void)
{
	...
	if(RefreshFlag){
		...
		if(device_type == DEV_IM)
		{
			if(DATA_Registers[280] == 0)	  CLCD_string(0xC0,"    Terminal    ");
			else if(DATA_Registers[280] == 1) CLCD_string(0xC0,"    Operator    ");
			else if(DATA_Registers[280] == 2) CLCD_string(0xC0,"   Synchronous  ");
			else if(DATA_Registers[280] == 3) CLCD_string(0xC0,"    FieldBus    ");
			else if(DATA_Registers[280] == 4) CLCD_string(0xC0,"  Free Function ");
		}
		else if(device_type == DEV_DCDC)
		{
			SYS_ParameterDisplay(MODE_5d);
...
void SYS_1_2_03(void)
{
	...
	if(RefreshFlag){
		...
		if(device_type == DEV_IM)
		{
			if(DATA_Registers[281] == 0)	  CLCD_string(0xC0,"    Terminal    ");
			else if(DATA_Registers[281] == 1) CLCD_string(0xC0,"    Operator    ");
			else if(DATA_Registers[281] == 2) CLCD_string(0xC0,"   Synchronous  ");
			else if(DATA_Registers[281] == 3) CLCD_string(0xC0,"    FieldBus    ");
			else if(DATA_Registers[281] == 4) CLCD_string(0xC0,"  Free Function ");
...
void SYS_1_2_05(void)
{
	if(device_type == DEV_IM)
	{
		...
		if(RefreshFlag){
			...
			if(device_type == DEV_IM)
			{
				CLCD_string(0xC0,(char*)_TEXT("      % 5d V    ", ReadDataMem(249)));
			}
			else if(device_type == DEV_DCDC)
			{
...
void SYS_1_2_06(void)
{
	if(device_type == DEV_IM)
	{
		...
		if(RefreshFlag){
			...
			//CLCD_string(0xC0,(char*)_TEXT("      %05d      ",(int)DATA_Registers[200]));
			//SYS_ParameterDisplay(MODE_5d);
			if(DATA_Registers[200]==11)
				CLCD_string(0xC0,"Induction Motor ");//분류추가요망
		}
	}
	else if(device_type == DEV_DCDC)
	{
		...
		if(RefreshFlag){
			CLCD_string(0x80,(char*)_cpy_flash2memory(&PAGE_DIR_1_2_XX_DCDC[6][0]));
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d     ",(int)DATA_Registers[2357]/100,DATA_Registers[2357]%100));
		}
	}
}
...
void SYS_2_00(void)
{
	if(device_type == DEV_IM)
	{
		//SYS_NaviFunc( SYS_2, SYS_2_23, SYS_2_01, SYS_2_00_00);
...
void SYS_2_01(void)
{
	if(device_type == DEV_IM)
	{
		//SYS_NaviFunc( SYS_2, SYS_2_21, SYS_2_03, SYS_2_01_00);
		if(KeyState.KeyValue == ESC)MenuDisplay = SYS_2;
...
void SYS_2_06_00(void)
{
	...
	SYS_ParameterEdt(600,  edit_Temp, 2, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_01(void)
{
	...
	SYS_ParameterEdt(601,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_02(void)
{
	...
	SYS_ParameterEdt(602,  edit_Temp, 3, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_09(void)
{
	...
	SYS_ParameterEdt(609,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_10(void)
{
	...
	SYS_ParameterEdt(610,  edit_Temp, 5, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_11(void)
{
	...
	SYS_ParameterEdt(611,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_12(void)
{
	...
	SYS_ParameterEdt(612,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_13(void)
{
	...
	SYS_ParameterEdt(613,  edit_Temp, 3, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_14(void)
{
	...
	SYS_ParameterEdt(614,  edit_Temp, 2000, 1, EDIT_MODE_1);
...
void SYS_2_06_20(void)
{
	...
	SYS_ParameterEdt(620,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_21(void)
{
	...
	SYS_ParameterEdt(621,  edit_Temp, 5, 0, EDIT_MODE_UPDN);
...
void SYS_2_06_22(void)
{
	...
	SYS_ParameterEdt(622,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_08_00(void)
{
	...
	SYS_ParameterEdt(810,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_2_08_01(void)
{
	...
	SYS_ParameterEdt(811,  edit_Temp, 11, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_02(void)
{
	...
	SYS_ParameterEdt(812,  edit_Temp, 11, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_03(void)
{
	...
	SYS_ParameterEdt(813,  edit_Temp, 11, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_04(void)
{
	...
	SYS_ParameterEdt(814,  edit_Temp, 11, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_05(void)
{
	...
	SYS_ParameterEdt(815,  edit_Temp, 11, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_06(void)
{
	...
	SYS_ParameterEdt(816,  edit_Temp, 11, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_07(void)
{
	...
	SYS_ParameterEdt(817,  edit_Temp, 65000, 0, EDIT_MODE_UPDN);
...
void SYS_2_08_08(void)
{
	...
	SYS_ParameterEdt(818,  edit_Temp, 65000, 0, EDIT_MODE_UPDN);
...
void SYS_2_08_09(void)
{
	...
	SYS_ParameterEdt(819,  edit_Temp, 65000, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_08_10(void)
{
	...
	SYS_ParameterEdt(820,  edit_Temp, 65000, 0, EDIT_MODE_P8_DI_FUNC);
...
void SYS_2_11_00(void)
{
	...
	SYS_ParameterEdt(940,  edit_Temp, 10, 0, EDIT_MODE_P11_AO_Sel);

	if(RefreshFlag)
	{
		Temporary = ReadDataMem(940);
		CLCD_string(0x80,(char*)_cpy_flash2memory(&PAGE_DIR_2_11_XX[0][0]));
		SYS_ParameterDisplay(MODE_P11_AO_Sel);
	}
}
void SYS_2_11_01(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_P11_AO_Type);
	}
}
...
void SYS_2_12_00(void)
{
	...
	SYS_ParameterEdt(960,  edit_Temp, 4, 0, EDIT_MODE_UPDN);

	if(RefreshFlag)
	{
		Temporary = ReadDataMem(960);
		CLCD_string(0x80,(char*)_cpy_flash2memory(&PAGE_DIR_2_12_XX[0][0]));
		SYS_ParameterDisplay(MODE_P12_DO_FUNC);
	}
}
void SYS_2_12_01(void)
{
	...
	SYS_ParameterEdt(961,  edit_Temp, 4, 0, EDIT_MODE_UPDN);
...
void SYS_2_12_02(void)
{
	...
	SYS_ParameterEdt(962,  edit_Temp, 4, 0, EDIT_MODE_UPDN);
...
void SYS_2_19_01(void)
{
	...
	SYS_ParameterEdt(1371,  edit_Temp, 1, 0, EDIT_MODE_UPDN);
...
void SYS_4_00_00(void)
{
	if(TimeTic_1s)
	{
		...
		SCI_RequestData(2400);
		SCI_RequestData(2401);
		SCI_RequestData(2402);
		SCI_RequestData(2403);
		SCI_RequestData(2404);
		SCI_RequestData(2405);
		RefreshFlag = 1;
	}
	...
	if(RefreshFlag){
		if(Temporary==0)
		{
			...
			else CLCD_string(0xC0,(char*)_TEXT(" NoCode:% 3d     ",(int)DATA_Registers[2393]));
		}
		else if(Temporary==1)
		{
			CLCD_string(0x80," *Drive Status* ");
			if(DATA_Registers[2394] == 'Y')     CLCD_string(0xC0,"    POWER ON    ");
			else if(DATA_Registers[2394] == 'Z')CLCD_string(0xC0,"    INIT CAL    ");
			else if(DATA_Registers[2394] == 'C')CLCD_string(0xC0,"    DRIVE CAL   ");
			else if(DATA_Registers[2394] == 'R')CLCD_string(0xC0,"     READY      ");
			else if(DATA_Registers[2394] == 'S')CLCD_string(0xC0,"      STOP      ");
			else if(DATA_Registers[2394] == 'B')CLCD_string(0xC0,"    BREAKING    ");
			else if(DATA_Registers[2394] == 'A')CLCD_string(0xC0,"  ACCELERATING  ");
			else if(DATA_Registers[2394] == 'D')CLCD_string(0xC0,"  DECELERATING  ");
			else if(DATA_Registers[2394] == 'O')CLCD_string(0xC0,"     RUNNING    ");
			else if(DATA_Registers[2394] == 'T')CLCD_string(0xC0,"     TUNING     ");
			else if(DATA_Registers[2394] == 'F')CLCD_string(0xC0,"     FAULT      ");
											
		}	
		else if(Temporary==2)
		{
			CLCD_string(0x80," Motor Current  ");
			CLCD_string(0xC0,(char*)_TEXT("     % 4d.% 1d A    ",(int)DATA_Registers[2395]/10,(int)DATA_Registers[2395]%10));
		}
		else if(Temporary==3)
		{
			CLCD_string(0x80,"  DC_Link Volt  ");
			CLCD_string(0xC0,(char*)_TEXT("      % 5d V     ",(int)DATA_Registers[2396]));
		}
		else if(Temporary==4)
		{
			CLCD_string(0x80,"  Motor Speed   ");
			CLCD_string(0xC0,(char*)_TEXT("      % 5d rpm  ",(int)DATA_Registers[2397]));
		}
		else if(Temporary==5)
		{
			CLCD_string(0x80,"  Temperature   ");
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d deg  ",(int)DATA_Registers[2398]/10,(int)DATA_Registers[2398]%10));
		}
		else if(Temporary==6)
		{
			CLCD_string(0x80," Actual Torque  ");
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1d %    ",(int)DATA_Registers[2399]/10,(int)DATA_Registers[2399]%10));
		}
		else if(Temporary==7)
		{
			CLCD_string(0x80,"  Torq Current  ");
			CLCD_string(0xC0,(char*)_TEXT("     % 4d.% 1d A    ",(int)DATA_Registers[2400]/10,(int)DATA_Registers[2400]%10));
		}
		else if(Temporary==8)
		{
			CLCD_string(0x80,"  Flux Current  ");
			CLCD_string(0xC0,(char*)_TEXT("     % 4d.% 1d A    ",(int)DATA_Registers[2401]/10,(int)DATA_Registers[2401]%10));
		}
		else if(Temporary==9)
		{
			CLCD_string(0x80,"  Output Power  ");
			CLCD_string(0xC0,(char*)_TEXT("     % 4d.% 1d kW   ",(int)DATA_Registers[2402]/10,(int)DATA_Registers[2402]%10));
		}
		else if(Temporary==10)
		{
			CLCD_string(0x80,"Phase Current A ");
			CLCD_string(0xC0,(char*)_TEXT("      % 4d.% 1d A    ",(int)DATA_Registers[2403]/10,(int)DATA_Registers[2403]%10));
		}
		else if(Temporary==11)
		{
			CLCD_string(0x80,"Phase Current B ");
			CLCD_string(0xC0,(char*)_TEXT("      % 4d.% 1d A    ",(int)DATA_Registers[2404]/10,(int)DATA_Registers[2404]%10));
		}
		else if(Temporary==12)
		{
			CLCD_string(0x80,"Phase Current C ");
			CLCD_string(0xC0,(char*)_TEXT("      % 4d.% 1d A    ",(int)DATA_Registers[2405]/10,(int)DATA_Registers[2405]%10));
		}
...
const char* _TEXT_(char const *format, ...)
{
