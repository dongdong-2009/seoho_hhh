...
#define MODE_3d_1u_mF 59
#define MODE_3d_1u_mH 60
...
__flash char  PAGE_DIR_2_29_XX[27][17]={
 "P29.0 PWM_Freq      ",
 "P29.1 Vdc_Out Set   ",
 "P29.2 Rtd_Input Volt",
 "P29.3 Rtd_Output Pwr",
 "P29.4 Reactor Res   ",
 "P29.5 Reactor_Ind   ",
 "P29.6 Volt Sens_Time",
 "P29.7 VC P-Gain     ",
 "P29.8 VC I-Gain     ",
 "P29.9 CC P-Gain     ",
 "P29.10 CC I-Gain    ",
 ...
 "P29.20 In Rtd Curr  ",
 "P29.21 OC Set Val   ",
 "P29.22 Max Cont Curr",
 "P29.23 OL-Curr Value",
 "P29.24 OL Time      ",
 "P29.25 OV Time      ",
 "P29.26 OT-Set Value "
 };
...
void SYS_ParameterDisplay(unsigned char mode)
{
	...
	else if(mode == MODE_3d_1u_mF)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1u mF   ",(int)Temporary/10,Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("      % 3d.% 1u mF   ",(int)edit_Temp/10,edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}
...
void SYS_ParameterEdt(unsigned int addr,unsigned int e_temp, unsigned char mode)
{
	...
	if(mode==CURSOR_MODE_1)//unsigned int
	{
	...
	else if(mode==CURSOR_MODE_2)//selset
	{
			if(KeyState.KeyValue == ENTER)
			{
				WriteDataMem(addr, e_temp);
	...
	else if(mode==CURSOR_MODE_3)//selset
	{
			if(KeyState.KeyValue == ENTER)
			{
				WriteDataMem(addr, e_temp);
	...
	else if(mode==CURSOR_MODE_4)//int
	{
		if(posInpage==1)
		{
...
void SYS_2_08_01(void)
{
	...
	SYS_ParameterEdt(811,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_02(void)
{
	...
	SYS_ParameterEdt(812,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_03(void)
{
	...
	SYS_ParameterEdt(813,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_04(void)
{
	...
	SYS_ParameterEdt(814,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_05(void)
{
	...
	SYS_ParameterEdt(815,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_06(void)
{
	...
	SYS_ParameterEdt(816,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_07(void)
{
	...
	SYS_ParameterEdt(817,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_08(void)
{
	...
	SYS_ParameterEdt(818,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_09(void)
{
	...
	SYS_ParameterEdt(819,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_10(void)
{
	...
	SYS_ParameterEdt(820,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_11(void)
{
	...
	SYS_ParameterEdt(821,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_12(void)
{
	...
	SYS_ParameterEdt(822,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_13(void)
{
	...
	SYS_ParameterEdt(823,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_14(void)
{
	...
	SYS_ParameterEdt(824,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_15(void)
{
	...
	SYS_ParameterEdt(825,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_16(void)
{
	...
	SYS_ParameterEdt(826,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_17(void)
{
	...
	SYS_ParameterEdt(827,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_18(void)
{
	...
	SYS_ParameterEdt(828,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_08_19(void)
{
	...
	SYS_ParameterEdt(829,  edit_Temp, CURSOR_MODE_3);
...
void SYS_2_11_02(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_3d_1u_pu);
	}
}
...
void SYS_2_29_00(void)
{
	...
	SYS_ParameterEdt(1870,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_01(void)
{
	...
	SYS_ParameterEdt(1871,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_02(void)
{
	...
	SYS_ParameterEdt(1872,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_03(void)
{
	...
	SYS_ParameterEdt(1873,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_08(void)
{
	...
	SYS_ParameterEdt(1878,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_09(void)
{
	...
	SYS_ParameterEdt(1879,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_10(void)
{
	...
	SYS_ParameterEdt(1880,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_11(void)
{
	...
	SYS_ParameterEdt(1881,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_12(void)
{
	...
	SYS_ParameterEdt(1882,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_13(void)
{
	...
	SYS_ParameterEdt(1883,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_14(void)
{
	...
	SYS_ParameterEdt(1884,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_15(void)
{
	...
	SYS_ParameterEdt(1885,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_16(void)
{
	...
	SYS_ParameterEdt(1886,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_17(void)
{
	...
	SYS_ParameterEdt(1887,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_18(void)
{
	...
	SYS_ParameterEdt(1888,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_20(void)
{
	...
	SYS_ParameterEdt(1890,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_21(void)
{
	...
	SYS_ParameterEdt(1891,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_22(void)
{
	...
	SYS_ParameterEdt(1892,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_23(void)
{
	...
	SYS_ParameterEdt(1893,  edit_Temp, CURSOR_MODE_1);
...
void SYS_2_29_26(void)
{
	...
	SYS_ParameterEdt(1896,  edit_Temp, CURSOR_MODE_1);
