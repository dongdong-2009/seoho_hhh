...
struct RAMP_CONTROL_CONFIGURATION1
{
	...
	int		P51_S_curve_enable;
	int		P52_S_curve_weight_x1000;
};
...
// ryu
struct CANOPEN_CONTROL_WORD_BITS
{
	Uint16 Switch_on:1;
	Uint16 Enable_voltage:1;
	Uint16 Quickstop:1;
	Uint16 Enable_opeation:1;
	Uint16 Operation_mode_specific1:1;
	Uint16 Operation_mode_specific2:1;
	Uint16 Operation_mode_specific3:1;
	Uint16 Fault_reset:1;
	Uint16 Halt:1;
	Uint16 Operation_mode_specific4:1;
	Uint16 rsvd:1;
	Uint16 Emergency_feather_command:1;
	Uint16 Manufacturer_specific1:1;
	Uint16 Manufacturer_specific2:2;
	Uint16 Manufacturer_specific3:3;
   	Uint16 Manufacturer_specific4:4;
};

union CANOPEN_CONTROL_WORD
{
   	Uint16 all;
	struct
	{
	...
	struct CANOPEN_CONTROL_WORD_BITS bit;
};

struct CANOPEN_STATUS_WORD_BITS
{
   	Uint16 Ready_to_Switch_on:1;
	Uint16 Switched_on:1;
	Uint16 Operation_enabled:1;
	Uint16 Fault:1;
	Uint16 Voltage_enabled:1;
	Uint16 Quickstop:1;
	Uint16 Switch_on_disabled:1;
	Uint16 Warning:1;
	Uint16 Manufacturer_specific1:1;
	Uint16 Remote:1;
	Uint16 Target_reached:1;
	Uint16 Internal_limit_active:1;
	Uint16 Operation_mode_specific1:1;
	Uint16 Operation_mode_specific2:1;
	Uint16 Manufacturer_specific2:1;
	Uint16 Manufacturer_specific3:1;
};

union CANOPEN_STATUS_WORD
{
   	Uint16 all;
	struct
	{
	...
	struct CANOPEN_STATUS_WORD_BITS bit;
};

union CANOPEN_POSITION
{
	Uint16 all;
	struct 
	{
...
struct CANOPEN_PARAMETERS
{
    union CANOPEN_CONTROL_WORD    ControlWord;
	union CANOPEN_STATUS_WORD     StatusWord;
	union CANOPEN_POSITION        Position;
	union CANOPEN_TARGET_POSITION TargetPosition;
};
