...
#include "Core_I2C_eeprom.h"


// Initialize I2C for serial eeprom(24LC512) access
void I2C_EEPROM_Initialization(void)
{
...
#pragma CODE_SECTION(Read_EEPROM_Data, "ramfuncs");
...
#pragma CODE_SECTION(Word_Write_data, "ramfuncs");
...
#pragma CODE_SECTION(Word_Read_data, "ramfuncs");
