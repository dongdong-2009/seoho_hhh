...
void Set_InitialTime(void)
{
	...
	Write_RTC_Data(RTC_REGS_MINUTE, 0x17);		// minute
	Write_RTC_Data(RTC_REGS_HOUR, 	0x17);		// hour
	Write_RTC_Data(RTC_REGS_WEEK, 	0x01);		// week
	Write_RTC_Data(RTC_REGS_DATE, 	0x04);		// date
	Write_RTC_Data(RTC_REGS_MONTH, 	0x08);		// month
