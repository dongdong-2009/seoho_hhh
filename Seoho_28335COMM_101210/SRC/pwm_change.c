...
void pwm_g1_setup(int buf_dir,int pwm_dir, double sys_clk, double dead_time)
{
    ...
    // Setup compare 
    EPwm1Regs.CMPA.half.CMPA = (((unsigned int)(Tsamp/(2*(1/sys_clk))))>>1);
    ...
    // Setup compare 
    EPwm2Regs.CMPA.half.CMPA = (((unsigned int)(Tsamp/(2*(1/sys_clk))))>>1);   
    ...
    // Setup compare 
    EPwm3Regs.CMPA.half.CMPA = (((unsigned int)(Tsamp/(2*(1/sys_clk))))>>1);   
   ...
   EPwm5Regs.ETSEL.bit.INTEN 		= 0;                  // Enable INT
	...
	pwm_g1.phase_duty_half_scaled = (((unsigned int)(Tsamp/(2*(1/sys_clk))))>>1);
