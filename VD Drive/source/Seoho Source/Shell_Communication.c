...
void Read_Data_Registers(int Parameter_index)
{
	switch(Parameter_index)
	{
		...
		case 208:	P.G00.Drive_power_x10_kW= 						Data_Registers[Parameter_index];	break; 
		case 209:	P.G00.Password= 								Data_Registers[Parameter_index];	break;
		case 210:	P.G00.IGBT_current= 							Data_Registers[Parameter_index];	break;
		...
		case 601:	P.G06.AI1.P00_Function= 						Data_Registers[Parameter_index];	break;			
		case 602:	P.G06.AI1.P01_Type= 							Data_Registers[Parameter_index];	break;					
		case 604:	P.G06.AI1.P02_Filter_time_constant_x10_mA= 		Data_Registers[Parameter_index];	break;
		case 605:	P.G06.AI1.P03_Offset= 							Data_Registers[Parameter_index];	break;				
		case 606:	P.G06.AI1.P04_Minimum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 607:	P.G06.AI1.P05_Minimum_current_x10_mA= 			Data_Registers[Parameter_index];	break;		
		case 608:	P.G06.AI1.P06_Minimum_x1000= 					Data_Registers[Parameter_index];	break;				
		case 609:	P.G06.AI1.P07_Maximum_voltage_x10= 				Data_Registers[Parameter_index];	break;	
		case 610:	P.G06.AI1.P08_Maximum_current_x10_mA= 			Data_Registers[Parameter_index];	break;		
		case 611:	P.G06.AI1.P09_Maximum_x1000= 					Data_Registers[Parameter_index];	break;				
		case 612:	P.G06.AI1.P10_Inversion= 						Data_Registers[Parameter_index];	break;				
		case 613:	P.G06.AI1.P11_Discretness= 						Data_Registers[Parameter_index];	break;			
		case 614:	P.G06.AI1.P12_Dead_zone= 						Data_Registers[Parameter_index];	break;				
		case 615:	P.G06.AI2.P00_Function= 						Data_Registers[Parameter_index];	break;		
		case 616:	P.G06.AI2.P01_Type= 							Data_Registers[Parameter_index];	break;				
		case 618:	P.G06.AI2.P02_Filter_time_constant_x10_mA= 		Data_Registers[Parameter_index];	break;
		case 619:	P.G06.AI2.P03_Offset= 							Data_Registers[Parameter_index];	break;			
		case 620:	P.G06.AI2.P04_Minimum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 621:	P.G06.AI2.P05_Minimum_current_x10_mA= 			Data_Registers[Parameter_index];	break;			
		case 622:	P.G06.AI2.P06_Minimum_x1000= 					Data_Registers[Parameter_index];	break;				
		case 623:	P.G06.AI2.P07_Maximum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 624:	P.G06.AI2.P08_Maximum_current_x10_mA= 			Data_Registers[Parameter_index];	break;	
		case 625:	P.G06.AI2.P09_Maximum_x1000= 					Data_Registers[Parameter_index];	break;			
		case 626:	P.G06.AI2.P10_Inversion= 						Data_Registers[Parameter_index];	break;				
		case 627:	P.G06.AI2.P11_Discretness= 						Data_Registers[Parameter_index];	break;			
		case 628:	P.G06.AI2.P12_Dead_zone=						Data_Registers[Parameter_index];	break;		
		case 629:	P.G06.AI3.P00_Function= 						Data_Registers[Parameter_index];	break;		
		case 630:	P.G06.AI3.P01_Type= 							Data_Registers[Parameter_index];	break;					
		case 632:	P.G06.AI3.P02_Filter_time_constant_x10_mA= 		Data_Registers[Parameter_index];	break;	
		case 633:	P.G06.AI3.P03_Offset= 							Data_Registers[Parameter_index];	break;			
		case 634:	P.G06.AI3.P04_Minimum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 635:	P.G06.AI3.P05_Minimum_current_x10_mA= 			Data_Registers[Parameter_index];	break;		
		case 636:	P.G06.AI3.P06_Minimum_x1000= 					Data_Registers[Parameter_index];	break;
		case 637:	P.G06.AI3.P07_Maximum_voltage_x10=				Data_Registers[Parameter_index];	break;	
		case 638:	P.G06.AI3.P08_Maximum_current_x10_mA= 			Data_Registers[Parameter_index];	break;	
		case 639:	P.G06.AI3.P09_Maximum_x1000= 					Data_Registers[Parameter_index];	break;		
		case 640:	P.G06.AI3.P10_Inversion= 						Data_Registers[Parameter_index];	break;				
		case 641:	P.G06.AI3.P11_Discretness= 						Data_Registers[Parameter_index];	break;		
		case 642:	P.G06.AI3.P12_Dead_zone= 						Data_Registers[Parameter_index];	break;		
		case 643:	P.G06.AI4.P00_Function= 						Data_Registers[Parameter_index];	break;		
		case 644:	P.G06.AI4.P01_Type= 							Data_Registers[Parameter_index];	break;					
		case 646:	P.G06.AI4.P02_Filter_time_constant_x10_mA= 		Data_Registers[Parameter_index];	break;
		case 647:	P.G06.AI4.P03_Offset= 							Data_Registers[Parameter_index];	break;		
		case 648:	P.G06.AI4.P04_Minimum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 649:	P.G06.AI4.P05_Minimum_current_x10_mA=			Data_Registers[Parameter_index];	break;		
		case 650:	P.G06.AI4.P06_Minimum_x1000= 					Data_Registers[Parameter_index];	break;		
		case 651:	P.G06.AI4.P07_Maximum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 652:	P.G06.AI4.P08_Maximum_current_x10_mA= 			Data_Registers[Parameter_index];	break;	
		case 653:	P.G06.AI4.P09_Maximum_x1000= 					Data_Registers[Parameter_index];	break;		
		case 654:	P.G06.AI4.P10_Inversion= 						Data_Registers[Parameter_index];	break;	
		case 655:	P.G06.AI4.P11_Discretness= 						Data_Registers[Parameter_index];	break;		
		case 656:	P.G06.AI4.P12_Dead_zone= 						Data_Registers[Parameter_index];	break;		
		case 657:	P.G06.AI5.P00_Function= 						Data_Registers[Parameter_index];	break;			
		case 658:	P.G06.AI5.P01_Type= 							Data_Registers[Parameter_index];	break;				
		case 660:	P.G06.AI5.P02_Filter_time_constant_x10_mA= 		Data_Registers[Parameter_index];	break;	
		case 661:	P.G06.AI5.P03_Offset= 							Data_Registers[Parameter_index];	break;				
		case 662:	P.G06.AI5.P04_Minimum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 663:	P.G06.AI5.P05_Minimum_current_x10_mA= 			Data_Registers[Parameter_index];	break;		
		case 664:	P.G06.AI5.P06_Minimum_x1000= 					Data_Registers[Parameter_index];	break;			
		case 665:	P.G06.AI5.P07_Maximum_voltage_x10= 				Data_Registers[Parameter_index];	break;		
		case 666:	P.G06.AI5.P08_Maximum_current_x10_mA= 			Data_Registers[Parameter_index];	break;	
		case 667:	P.G06.AI5.P09_Maximum_x1000= 					Data_Registers[Parameter_index];	break;			
		case 668:	P.G06.AI5.P10_Inversion= 						Data_Registers[Parameter_index];	break;				
		case 669:	P.G06.AI5.P11_Discretness= 						Data_Registers[Parameter_index];	break;	
		case 670:	P.G06.AI5.P12_Dead_zone= 						Data_Registers[Parameter_index];	break;			
...
//	Data_Registers[2319]= 	(int)(Vqse_ref*Iqse); 						
	Data_Registers[2323]= 	(int)Temperature_x10; 	
...
void Write_Data_Registers_Offline(int Parameter_index)
{
	switch(Parameter_index)
	{
		case 208:	Data_Registers[Parameter_index]= 	P.G00.Drive_power_x10_kW;					break; 
		case 209:	Data_Registers[Parameter_index]= 	P.G00.Password; 							break;
		case 210:	Data_Registers[Parameter_index]= 	P.G00.IGBT_current; 						break;
		...
		case 601:	Data_Registers[Parameter_index]= 	P.G06.AI1.P00_Function; 					break;			
		case 602:	Data_Registers[Parameter_index]= 	P.G06.AI1.P01_Type; 						break;					
		case 604:	Data_Registers[Parameter_index]= 	P.G06.AI1.P02_Filter_time_constant_x10_mA; 	break;
		case 605:	Data_Registers[Parameter_index]= 	P.G06.AI1.P03_Offset; 						break;				
		case 606:	Data_Registers[Parameter_index]= 	P.G06.AI1.P04_Minimum_voltage_x10; 			break;		
		case 607:	Data_Registers[Parameter_index]= 	P.G06.AI1.P05_Minimum_current_x10_mA; 		break;		
		case 608:	Data_Registers[Parameter_index]= 	P.G06.AI1.P06_Minimum_x1000; 				break;				
		case 609:	Data_Registers[Parameter_index]= 	P.G06.AI1.P07_Maximum_voltage_x10; 			break;	
		case 610:	Data_Registers[Parameter_index]= 	P.G06.AI1.P08_Maximum_current_x10_mA; 		break;		
		case 611:	Data_Registers[Parameter_index]= 	P.G06.AI1.P09_Maximum_x1000; 				break;				
		case 612:	Data_Registers[Parameter_index]= 	P.G06.AI1.P10_Inversion; 					break;				
		case 613:	Data_Registers[Parameter_index]= 	P.G06.AI1.P11_Discretness; 					break;			
		case 614:	Data_Registers[Parameter_index]= 	P.G06.AI1.P12_Dead_zone; 					break;				
		case 615:	Data_Registers[Parameter_index]= 	P.G06.AI2.P00_Function; 					break;		
		case 616:	Data_Registers[Parameter_index]= 	P.G06.AI2.P01_Type; 						break;				
		case 618:	Data_Registers[Parameter_index]= 	P.G06.AI2.P02_Filter_time_constant_x10_mA; 	break;
		case 619:	Data_Registers[Parameter_index]= 	P.G06.AI2.P03_Offset; 						break;			
		case 620:	Data_Registers[Parameter_index]= 	P.G06.AI2.P04_Minimum_voltage_x10; 			break;		
		case 621:	Data_Registers[Parameter_index]= 	P.G06.AI2.P05_Minimum_current_x10_mA; 		break;			
		case 622:	Data_Registers[Parameter_index]= 	P.G06.AI2.P06_Minimum_x1000; 				break;				
		case 623:	Data_Registers[Parameter_index]= 	P.G06.AI2.P07_Maximum_voltage_x10; 			break;		
		case 624:	Data_Registers[Parameter_index]= 	P.G06.AI2.P08_Maximum_current_x10_mA; 		break;	
		case 625:	Data_Registers[Parameter_index]= 	P.G06.AI2.P09_Maximum_x1000; 				break;			
		case 626:	Data_Registers[Parameter_index]= 	P.G06.AI2.P10_Inversion; 					break;				
		case 627:	Data_Registers[Parameter_index]= 	P.G06.AI2.P11_Discretness; 					break;			
		case 628:	Data_Registers[Parameter_index]= 	P.G06.AI2.P12_Dead_zone;					break;		
		case 629:	Data_Registers[Parameter_index]= 	P.G06.AI3.P00_Function; 					break;		
		case 630:	Data_Registers[Parameter_index]= 	P.G06.AI3.P01_Type; 						break;					
		case 632:	Data_Registers[Parameter_index]= 	P.G06.AI3.P02_Filter_time_constant_x10_mA; 	break;	
		case 633:	Data_Registers[Parameter_index]= 	P.G06.AI3.P03_Offset; 						break;			
		case 634:	Data_Registers[Parameter_index]= 	P.G06.AI3.P04_Minimum_voltage_x10; 			break;		
		case 635:	Data_Registers[Parameter_index]= 	P.G06.AI3.P05_Minimum_current_x10_mA; 		break;		
		case 636:	Data_Registers[Parameter_index]= 	P.G06.AI3.P06_Minimum_x1000; 				break;
		case 637:	Data_Registers[Parameter_index]= 	P.G06.AI3.P07_Maximum_voltage_x10;			break;	
		case 638:	Data_Registers[Parameter_index]= 	P.G06.AI3.P08_Maximum_current_x10_mA; 		break;	
		case 639:	Data_Registers[Parameter_index]= 	P.G06.AI3.P09_Maximum_x1000; 				break;		
		case 640:	Data_Registers[Parameter_index]=	P.G06.AI3.P10_Inversion; 					break;				
		case 641:	Data_Registers[Parameter_index]= 	P.G06.AI3.P11_Discretness; 					break;		
		case 642:	Data_Registers[Parameter_index]= 	P.G06.AI3.P12_Dead_zone; 					break;		
		case 643:	Data_Registers[Parameter_index]= 	P.G06.AI4.P00_Function; 					break;		
		case 644:	Data_Registers[Parameter_index]= 	P.G06.AI4.P01_Type; 						break;					
		case 646:	Data_Registers[Parameter_index]= 	P.G06.AI4.P02_Filter_time_constant_x10_mA; 	break;
		case 647:	Data_Registers[Parameter_index]= 	P.G06.AI4.P03_Offset; 						break;		
		case 648:	Data_Registers[Parameter_index]= 	P.G06.AI4.P04_Minimum_voltage_x10; 			break;		
		case 649:	Data_Registers[Parameter_index]= 	P.G06.AI4.P05_Minimum_current_x10_mA;		break;		
		case 650:	Data_Registers[Parameter_index]= 	P.G06.AI4.P06_Minimum_x1000; 				break;		
		case 651:	Data_Registers[Parameter_index]= 	P.G06.AI4.P07_Maximum_voltage_x10; 			break;		
		case 652:	Data_Registers[Parameter_index]= 	P.G06.AI4.P08_Maximum_current_x10_mA; 		break;	
		case 653:	Data_Registers[Parameter_index]= 	P.G06.AI4.P09_Maximum_x1000; 				break;		
		case 654:	Data_Registers[Parameter_index]= 	P.G06.AI4.P10_Inversion; 					break;	
		case 655:	Data_Registers[Parameter_index]= 	P.G06.AI4.P11_Discretness; 					break;		
		case 656:	Data_Registers[Parameter_index]= 	P.G06.AI4.P12_Dead_zone; 					break;		
		case 657:	Data_Registers[Parameter_index]= 	P.G06.AI5.P00_Function; 					break;			
		case 658:	Data_Registers[Parameter_index]= 	P.G06.AI5.P01_Type; 						break;				
		case 660:	Data_Registers[Parameter_index]= 	P.G06.AI5.P02_Filter_time_constant_x10_mA; 	break;	
		case 661:	Data_Registers[Parameter_index]= 	P.G06.AI5.P03_Offset; 						break;				
		case 662:	Data_Registers[Parameter_index]= 	P.G06.AI5.P04_Minimum_voltage_x10; 			break;		
		case 663:	Data_Registers[Parameter_index]= 	P.G06.AI5.P05_Minimum_current_x10_mA; 		break;		
		case 664:	Data_Registers[Parameter_index]= 	P.G06.AI5.P06_Minimum_x1000; 				break;			
		case 665:	Data_Registers[Parameter_index]= 	P.G06.AI5.P07_Maximum_voltage_x10; 			break;		
		case 666:	Data_Registers[Parameter_index]= 	P.G06.AI5.P08_Maximum_current_x10_mA; 		break;	
		case 667:	Data_Registers[Parameter_index]= 	P.G06.AI5.P09_Maximum_x1000; 				break;			
		case 668:	Data_Registers[Parameter_index]= 	P.G06.AI5.P10_Inversion; 					break;				
		case 669:	Data_Registers[Parameter_index]= 	P.G06.AI5.P11_Discretness; 					break;	
		case 670:	Data_Registers[Parameter_index]= 	P.G06.AI5.P12_Dead_zone; 					break;			
