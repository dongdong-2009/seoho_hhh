...
//	GpioCtrlRegs.GPAMUX2.bit.GPIO26 = 3;	// GPIO26 is MCLKXB pin ( (bayasaa. it is used to Boot_mode))
...
//	GpioCtrlRegs.GPAMUX2.bit.GPIO27 = 3;	// GPIO27 is MFSXB pin ( (bayasaa. it is used to Boot_mode))
...
//	GpioCtrlRegs.GPAPUD.bit.GPIO26 = 0;	    // Enable pull-up on GPIO26 (MCLKXB) ( (bayasaa. it is used to Boot_mode))
...
//	GpioCtrlRegs.GPAPUD.bit.GPIO27 = 0;	    // Enable pull-up on GPIO27 (MFSXB) ( (bayasaa. it is used to Boot_mode))
...
//    GpioCtrlRegs.GPAQSEL2.bit.GPIO26 = 3;   // Asynch input GPIO26(MCLKXB) ( (bayasaa. it is used to Boot_mode))
...
//    GpioCtrlRegs.GPAQSEL2.bit.GPIO27 = 3;   // Asynch input GPIO27 (MFSXB) (bayasaa. it is used to Boot_mode)
